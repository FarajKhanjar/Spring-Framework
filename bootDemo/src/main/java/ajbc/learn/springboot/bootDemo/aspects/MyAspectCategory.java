...
//		System.out.println("Aspect calling to main");
	...
	@Before("execution(* ajbc.learn.springboot.bootDemo.daos.CategoryDao.*(..))")
	...
	@AfterThrowing(throwing = "ex", pointcut = "execution(* ajbc.learn.springboot.bootDemo.daos.CategoryDao.*(..))")
